        ...
        <div id="banner" className="flex flex-col-reverse md:flex-row pt-20 w-10/12 mx-auto">
            ...
            <div className={`md:w-1/2 max-w-full`}>
                <div className="my-20 Roboto_Slab">
                    ...
                    <p className="mb-2 text-white text-xs">Front-end developer skilled in HTML, CSS, Bootstrap, Tailwind CSS, JavaScript, and React.js. Seeking opportunities to create user-friendly web applications and contribute to exciting projects.</p>
