  ...
  return (
    <div className="bg-[#2A2C39]">
      <div id="about" className="w-10/12 mx-auto md:flex py-16">
        <div className="w-2/4 mx-auto animate-from-left">
          <img
        ...
        <div ref={ref} className="w-3/4 animate-from-right ml-10 md:ml-0">
          <h2 className="text-2xl font-bold mb-4">Hi, I&apos;m Sadikul Islam</h2>
          <p className="mb-4 text-white text-xs">
          ...
          <p className="text-white text-xs font-bold">Contact me at: sadikul14144@gmail.com</p>
